...
namespace BlogAPI.Src.Repositorios.Implementacoes
{
    public class PostagemRepositorio : IPostagem
    {
        ...
        public readonly BlogPessoalContexto _contexto;
        ...
        public async Task NovaPostagemAsync(Postagem postagem)
        {
            ...
            {
                var auxiliar = _contexto.Usuarios.FirstOrDefault(u => u.Id == postagem.Criador.Id);
                return auxiliar == null;
            }

            bool ExisteTemaId(int id)
            {
                var auxiliar = _contexto.Temas.FirstOrDefault(t => t.Id == postagem.Tema.Id);
                return auxiliar == null;
            }
        }
